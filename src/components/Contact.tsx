          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">(44) 99975-8472</p>
                  </div>
                </div>
            ...
            <div className="bg-slate-800 rounded-lg p-6 shadow-md">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://wa.me/5544999758472" className="bg-primary-900/30 p-3 rounded-full hover:bg-primary-800/40 transition-colors" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary-400" fill="currentColor" viewBox="0 0 24 24">
